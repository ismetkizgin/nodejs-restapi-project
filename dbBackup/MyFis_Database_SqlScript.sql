...
DELIMITER $$
USE `My-Fis`$$
CREATE PROCEDURE `UserLogin` ( IN UserIdentitiyNo INT,  IN UserPassword INT, OUT Result INT)
BEGIN
...
DELIMITER $$
USE `My-Fis`$$
CREATE PROCEDURE `AdminLogin` ( IN AdminIdentitiyNo INT,  IN AdminPassword INT, OUT Result INT)
BEGIN
